...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Allow WAITER, MANAGER, and ADMIN roles for cashier
      if (!['WAITER', 'MANAGER', 'ADMIN'].includes(data.user.role)) {
        throw new Error('Access denied. Waiter, Manager or Admin role required.')
      }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-500 to-teal-600">
      <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">💰 Cashier Terminal</h1>
